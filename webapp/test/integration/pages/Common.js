sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("carrpasp/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("carrpasp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["carrpasp/localService/mockserver"], function (mockserver) {
