...
sap.ui.define([
		...
		return BaseController.extend("carrpasp.controller.SegmentTbl", {
			...
			onInit : function () {
				...
				this.getRouter().getRoute("segmentTbl").attachPatternMatched(this._onMasterMatched, this);
			...
			onAdd : function(event) {
		      var dialog = this.byId("editDialog");
				...
				this.oCurContext = this.getModel().createEntry("/SEGMENT", {
					properties: oProperties
				});
		      	dialog.setBindingContext(this.oCurContext);
		      	dialog.setTitle("Добавление сегмента");
		      	dialog.open();
			},
			...
			onUpd : function(event) {
		      ...
		      if (this.oCurContext) {
		      	dialog.setBindingContext(this.oCurContext);
		      	dialog.setTitle("Редактирование сегмента");
		      	dialog.open();
		      }
			},
		   ...
		   onCancelPress: function() {
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						this.getRouter().navTo("segvalTbl", {objectId : sObjectId}, true);
					}.bind(this),
					function (mParams) {
						if (mParams.error) {
							return;
			...
			_showDetail : function (oItem) {
				...
				this.oCurContext = oItem.getBindingContext();
				this.getRouter().navTo("segvalTbl", {
