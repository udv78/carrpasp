		...
		return BaseController.extend("carrpasp.controller.CrunTbl", {
			...
			onInit : function () {
				...
				var oViewModel = new JSONModel({
					busy : false,
					delay : 0,
					lineItemListTitle : this.getResourceBundle().getText("crunTblTitle")
				});

				this.getRouter().getRoute("cpaspView").attachPatternMatched(this._onObjectMatched, this);

				this.setModel(oViewModel, "crunTbl");
			...
			onFilter: function() {
			    ...
			    this.getView().byId("crunItemsList").getBinding("items").filter(aFilters);
			},  

			onAdd : function(event) {
		      var dialog = this.byId("crunDialog");
				var oProperties = {
					ID: "" + parseInt(Math.random() * 1000000000, 10),  // С какого-то перепугу с меня требует ID, который GENERATED BY DEFAULT AS IDENTITY
					CNUM : ""+this.masterId
				};
			
				this.oCurContext = this.getModel().createEntry("/CRUN", {
		   ...
		   onCancelPress: function() {
			...
			_bindView : function (sObjectPath) {
				...
				var oViewModel = this.getModel("crunTbl");
			...
			_onMetadataLoaded : function () {
				...
				var iOriginalViewBusyDelay = this.getView().getBusyIndicatorDelay(),
					oViewModel = this.getModel("crunTbl"),
					oLineItemTable = this.byId("crunItemsList"),
