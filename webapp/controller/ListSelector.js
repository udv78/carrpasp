sap.ui.define([
		...
		return BaseObject.extend("carrpasp.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias carrpasp.model.ListSelector
			 */
			 ...
			 * @return {carrpasp.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
